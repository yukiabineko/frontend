  ...
  return(
    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
      <span className="navbar-brand text-white"><FontAwesomeIcon icon={faUtensils} />&nbsp;
            加工依頼アプリ</span>
      <button className="navbar-toggler bg-white text-primary font-weight-bold" type="button " data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
